...
def main():
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if args.local_rank == 0:
            ...
            # Log wandb metrics
            wandb.log( {"train/epoch_loss": tr_loss, "train/top1_acc": tr_prec1, "train/top5_acc": tr_prec5} )
            wandb.log( {"val/epoch_loss": val_loss, "val/top1_acc": prec1, "val/top5_acc": prec5} )

            # Log best_acc
            wandb.log( {"val/best_acc1": best_prec1, "val/best_acc5": best_prec5} )
